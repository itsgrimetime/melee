...
void grZebes_801D881C(HSD_GObj* gobj)
{
...

    {
        ...
        case 1:
            ...
            break;
        case 2:
            gp->gv.zebes5.xC6 = (s16) (gp->gv.zebes5.xC6 - 1);
...
void grZebes_801D9798(HSD_GObj* gobj)
{
    ...
    gp->gv.zebes5.xC6 =
        (s16) (grZe_804D6990->xA0_entries[gp->gv.zebes5.xC4].x0_base +
               delay_max);
    gp->gv.zebes5.xC8 = 0;
...
void grZebes_801D99E0(HSD_GObj* gobj)
{
    ...
    case 1: {
        ...
        if (gp->gv.zebes5.xC6 < 0) {
            ...
            } else if (gp->gv.zebes5.xD4 < grZe_804D6990->x90) {
                gp->gv.zebes5.xD4 = grZe_804D6990->x90;
            }
    ...
    case 3: {
        ...
        gp->gv.zebes5.xC6 = (s16) (gp->gv.zebes5.xC6 + 1);
        if (gp->gv.zebes5.xC6 < 60) {
            Camera_80030E44(1, NULL);
        }

        vel = gp->gv.zebes5.xD0;
        ...
        if (abs_delta <
            (f32) - ((0.5 * (f64) accel * (f64) (t * t)) - (f64) (vel * t)))
        {
            gp->gv.zebes5.xC8 = 4;
        } else {
            f32 abs_delta2;
    ...
    case 4: {
        ...
        gp->gv.zebes5.xD0 = gp->gv.zebes5.xD0 - grZe_804D6990->x9C;
    ...
    state4_done:
        ...
        gp->gv.zebes5.xC4 = (s16) (gp->gv.zebes5.xC4 + 1);
        {
            ...
            if (idx == 0x1E) {
                ...
                grZe_AcidLevelEntry* e = &grZe_804D6990->xA0_entries[idx];
                if (e->x0_base == 0 && e->x2_delay_min == 0 &&
                    e->x4_delay_max == 0 && e->x6_level == 0)
                {
                    gp->gv.zebes5.xC4 = 0;
                }
            }
        ...
        if (entry->x20_gobj != NULL) {
            ...
            if (bgp != NULL) {
...

                {
                    ...
                    if (diff > speed) {
                        entry->x18_size = current + speed;
                    } else if (diff < -speed) {
                        entry->x18_size = current - speed;
                    } else {
                        entry->x18_size = target;
                    }
                }

                if (entry->x04 != NULL &&
                    grAnime_801C83D0(entry->x20_gobj, 0, 7) != 0)
                {
                ...
                case 2: {
                    ...
                    if (arg1 < 7 && arg1 != 0 && arg1 != 6) {
                        ...
                        if (best_idx != -1) {
                            ...
                            entry->x04 = src->x04;
                            entry->x18_size = src->x18_size;
                            entry->x1C = src->x1C;
                            entry->x20_gobj = src->x20_gobj;
                            src->x00_active = 0;
                            src->x20_gobj = NULL;
                        } else {
                            for (j = 7; j < 20; j++) {
                    ...
                    if (left->x00_active != 0) {
                        ...
                        }
                        {
                            ...
                            if (dist > col_r) {
                                ...
                                fx = (dx / dist) * push + zero;
                                fy = (dy / dist) * push + zero;
                            }
                        }
                        neighbor_count = 1;
                    }
                    ...
                    for (; rem != 0; eb++, b++, rem--) {
                        if (eb->x00_active != 0) {
                            ...
                            }
                            {
                                ...
                                } else if (!(raw_dist < grZe_804D6990->x70 *
                                                            0.5f * avg_size) &&
        ...
        for (k = 0; k < 20; k++, p++) {
            if (p->x00_active != 0) {
                if (k == 0) {
                    p->x10 = 0.0f;
                    p->x14 = 0.0f;
                    p->x08_x = grZe_8049F158[0].x;
                    p->x0C_y = grZe_8049F158[0].y;
                } else if (k == 6) {
                    p->x10 = 0.0f;
                    p->x14 = 0.0f;
                    p->x08_x = grZe_8049F158[1].x;
                    p->x0C_y = grZe_8049F158[1].y;
                } else {
                    f32 old_y = p->x0C_y;
                    f32 old_x = p->x08_x;
...
void grZebes_801DC744(s32 arg0, u8 arg1)
{
    ...
    for (i = 0; i < 7; i++) {
        scales[i] = grZe_803B8044.x0_scales[i];
    }
