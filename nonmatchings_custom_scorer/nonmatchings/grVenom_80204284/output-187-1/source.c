...
void grVenom_80204284(Ground_GObj *gobj)
{
  ...
  new_var2 = gp;
  Ground_801C3BB4();
  timer = new_var2->gv.venom.xC8;
  if (((0, timer)) > 0)
  {
    new_var2->gv.venom.xC8 = timer + 1;
    if (((s32) new_var2->gv.venom.xC8) >= 0x3C)
    {
      if (((s32) new_var2->gv.venom.xC8) == 0x3C)
      {
        ifStatus_802F6898();
      ...
      else
      {
        ifStatus_802F6898();
        un_802FF570();
        if (0L == Ground_801C2BA4(1))
        {
          ifStatus_802F68F0();
          un_802FF620();
          new_var2->gv.venom.xC8 = -1;
        }
      }
    }
  }
