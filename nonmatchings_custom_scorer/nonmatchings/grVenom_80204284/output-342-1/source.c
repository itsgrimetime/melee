...
void grVenom_80204284(Ground_GObj *gobj)
{
  ...
  {
    gp->gv.venom.xC8 = 1;
    gp->gv.venom.xC8 = (timer + gp->gv.venom.xC8) & 0xFF;
    if (((s32) (((((((((((gp->gv.venom.xC8 & new_var) & new_var) & new_var) & new_var) & new_var) & new_var) & new_var) & new_var) & new_var) & 0xFFFFFFFF) & 0xFFFFFFFF)) >= 0x3C)
    {
