...
void grVenom_80204284(Ground_GObj *gobj)
{
  ...
  src_jobj = (HSD_JObj *) (new_var = HSD_GObjGetHSDObj(gobj));
  ...
  if (timer > 0)
  {
    ...
    {
      if (((s32) gp->gv.venom.xC8) == (((((((((0x3C & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu))
      {
        ifStatus_802F6898();
        un_802FF570();
