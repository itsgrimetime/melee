...
void grVenom_80204284(Ground_GObj *gobj)
{
  ...
  new_var5 = (new_var = ((HSD_GObj *) gp->gv.venom.xC4)->hsd_obj);
  dst_jobj = (HSD_JObj *) new_var5;
  ...
  if (timer > 0)
  {
    ...
    if (new_var2 >= 0x3C)
    {
      new_var4 = (Ground_GObj *) grVenom_80203EAC(1);
      if (new_var2 == 0x3C)
      {
        ifStatus_802F6898();
        un_802FF570();
        ...
        if (other_gobj != 0L)
        {
          ...
          new_var7 = &other_gp->gv.venom.xC4;
          grCorneria_801E25C4(other_gobj, new_var7, 4, 6, 0x6B6CC);
        }
      }
      else
      {
        ifStatus_802F6898();
 un_802FF570(); new_var6 = gp; if (Ground_801C2BA4(1) == 0L) {
          if (((!dst_jobj) && (!dst_jobj)) && (!dst_jobj))
          {
          }
          ifStatus_802F68F0();
          un_802FF620();
          new_var6->gv.venom.xC8 = inline_fn(1);
        }
      }
    }
  }
