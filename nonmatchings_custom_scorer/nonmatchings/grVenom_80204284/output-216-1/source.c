...
void grVenom_80204284(Ground_GObj *gobj)
{
  ...
  int new_var4;
  u32 pad;
  new_var2 = (Ground *) HSD_GObjGetUserData(gobj);
  gp = new_var2;
  src_jobj = (HSD_JObj *) HSD_GObjGetHSDObj(gobj);
  new_var3 = (HSD_JObj *) ((HSD_GObj *) gp->gv.venom.xC4)->hsd_obj;
  dst_jobj = new_var3;
    ...
    if (((s32) gp->gv.venom.xC8) >= 0x3C)
    {
      if (((s32) gp->gv.venom.xC8) == 0x3C)
      {
        ...
        if (other_gobj != 0L)
        {
          ...
          grCorneria_801E25C4(other_gobj, &other_gp->gv.venom.xC4, new_var4, 6, 0x6B6CC);
        }
      }
      else
      {
        ifStatus_802F6898();
        new_var = Ground_801C2BA4(1);
        ((HSD_GObj *) gp->gv.venom.xC4)->hsd_obj = ((HSD_GObj *) gp->gv.venom.xC4)->hsd_obj;
        un_802FF570();
        if (new_var == 0L)
        {
          ifStatus_802F68F0();
