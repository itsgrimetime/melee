...
void grVenom_80204284(Ground_GObj *gobj)
{
  ...
  timer = new_var;
  {
    ...
    {
      new_var2 = 1;
      new_var3 = grVenom_80203EAC(new_var2);
      if (((s32) new_var) == 0x3C)
      {
        ifStatus_802F6898();
        un_802FF570();
        other_gobj = (Ground_GObj *) new_var3;
        if (other_gobj != 0L)
        {
      ...
      else
      {
        ifStatus_802F6898();
        un_802FF570();
        if (Ground_801C2BA4(new_var2) == 0L)
        {
          ifStatus_802F68F0();
          un_802FF620();
          gp->gv.venom.xC8 = -new_var2;
        }
      }
    }
  }
