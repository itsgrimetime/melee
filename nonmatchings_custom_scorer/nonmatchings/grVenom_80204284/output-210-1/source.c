...
inline Ground_GObj *inline_fn()
{
  return (Ground_GObj *) grVenom_80203EAC(1);
}
...
void grVenom_80204284(Ground_GObj *gobj)
{
  ...
  if (timer > 0)
  {
 do { new_var = ((s32) gp->gv.venom.xC8) == 0x3C; } while (0);
    gp->gv.venom.xC8 = ((0, timer)) + 1;
