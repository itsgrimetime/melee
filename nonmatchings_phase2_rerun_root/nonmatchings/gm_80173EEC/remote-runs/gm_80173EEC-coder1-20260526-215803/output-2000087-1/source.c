...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 100)
    {
      ...
      {
        fn_80172C78(gm_80160474(CKIND_SEAK & 0xFFFFFFFFFFFFFFFFu, MJ_CLASSIC));
      }
      if (ckind == CKIND_SEAK)
      {
    ...
    {
      ckind = gm_8016400C(i);
      fn_80172C78(gm_80160474((((((ckind & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF, MJ_ALLSTAR));
      if (ckind == CKIND_ZELDA)
      {
