...
volatile unsigned int un_80304780(void);
...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 100)
    {
      ...
      i = gm_80160474(CKIND_SEAK, MJ_CLASSIC);
      new_var = CKIND_ZELDA;
      if (ckind == new_var)
      {
        fn_80172C78(i);
    ...
    {
      ckind = gm_8016400C(i);
      fn_80172C78(gm_80160474(ckind, MJ_ALLSTAR & 0xFFFFFFFF));
      if (ckind == new_var)
      {
      ...
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(gm_80160474(new_var, MJ_ALLSTAR));
      }
    }
  }
  ...
  if (new_var2 = gmMainLib_8015EDBC()->x14 >= 0x2710)
  {
    fn_80172C78(0x10C);
  }
  new_var2 = gmMainLib_8015D94C(0x1A) != 0;
  if (new_var2)
  {
    fn_80172C78(0x96);
  }
