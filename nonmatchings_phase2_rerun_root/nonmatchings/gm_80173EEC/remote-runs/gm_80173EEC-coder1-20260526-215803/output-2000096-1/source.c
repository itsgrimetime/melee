...
void gm_80173EEC(void)
{
  ...
  u8 ckind;
  u16 *temp_r29;
  for (i = 0; (((((((((((i & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 100)
    {
      ...
      {
        fn_80172C78(i = gm_80160474(CKIND_SEAK, MJ_CLASSIC));
      }
      if (ckind == CKIND_SEAK)
      {
