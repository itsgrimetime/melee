...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 100)
    {
      ...
      if ((((((((((ckind & 0xFFFFu) & 0xFFFFu) & 0xFFFFu) & 0xFFFFu) & 0xFFFFu) & 0xFFFFu) & 0xFFFFu) & 0xFFFFu) & 0xFFFFu) == CKIND_SEAK)
      {
    ...
    {
      ckind = gm_8016400C(i);
      i = gm_80160474(ckind, MJ_ALLSTAR);
      fn_80172C78(i);
      if (ckind == CKIND_ZELDA)
      {
      ...
      if (ckind == CKIND_SEAK)
      {
 do { fn_80172C78(gm_80160474(CKIND_ZELDA, MJ_ALLSTAR)); } while (0);
      }
    }
  }
