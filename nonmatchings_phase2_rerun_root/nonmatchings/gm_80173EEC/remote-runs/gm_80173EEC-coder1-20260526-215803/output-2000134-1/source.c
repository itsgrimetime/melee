...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 100)
    {
      ...
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(((((((0xFFFFFFFFFFFFFFFF & gm_80160474(CKIND_ZELDA, MJ_CLASSIC)) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF);
      }
    }
    if ((*temp_r29) >= 200)
    {
