...
## Round 3 object-callback regression

Added a two-invocation real object-callback replay using the existing copied-descriptor/object-chain fixture. Each invocation selects an object callback and runs a trial, while neither emits relocated-rejection-ledger hit/skip telemetry. No production change was required. Focused GREEN selection passed with 24 passed, 1157 deselected; py_compile, scoped Ruff, and diff check passed.
