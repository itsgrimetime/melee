...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    {
      ckind = gm_8016400C(i);
      fn_80172C78(gm_80160474((((((((((((ckind & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF) & 0xFFFF, MJ_ALLSTAR));
      if (ckind == CKIND_ZELDA)
      {
  ...
  new_var = (gmMainLib_8015EDBC()->x14 >= 0x2710) & 0xFF;
  if (new_var)
  {
    fn_80172C78(0x10C);
  }
