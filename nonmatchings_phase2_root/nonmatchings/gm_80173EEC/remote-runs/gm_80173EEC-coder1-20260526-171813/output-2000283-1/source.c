...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 100)
    {
      ckind = gm_8016400C(i) & 0xFFFFFFFFu;
      fn_80172C78(gm_80160474(ckind, MJ_CLASSIC));
      if (ckind == CKIND_ZELDA)
      {
        fn_80172C78(gm_80160474(CKIND_SEAK, MJ_CLASSIC));
      }
      if (((((((((ckind & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) & 0xFFFFFFFFFFFFFFFFu) == CKIND_SEAK)
      {
