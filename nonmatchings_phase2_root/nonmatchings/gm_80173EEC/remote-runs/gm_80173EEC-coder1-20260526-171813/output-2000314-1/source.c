...
inline bool inline_fn(volatile short arg0, int arg1)
{
...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 100)
    {
      ...
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(inline_fn((0, CKIND_ZELDA), MJ_CLASSIC));
      }
    }
    new_var2 = temp_r29;
    if ((*new_var2) >= 200)
    {
      new_var = MJ_ADVENTURE;
      ckind = gm_8016400C(i);
      fn_80172C78(inline_fn(ckind, new_var));
      if (ckind == CKIND_ZELDA)
      {
    ...
    if ((*temp_r29) >= 300)
    {
      ...
      if (ckind == CKIND_ZELDA)
      {
        fn_80172C78((float) inline_fn(CKIND_SEAK, MJ_ALLSTAR));
      }
  ...
  if ((gmMainLib_8015D94C(0x1A) & 0xFFFFFFFF) != 0)
  {
    fn_80172C78(0x96);
    ckind = gm_8016400C(i);
  }
