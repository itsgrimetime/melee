...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    if ((*temp_r29) >= 200)
    {
      ...
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(gm_80160474(new_var4, MJ_ADVENTURE));
      }
    }
    if ((*new_var2) >= 300)
    {
      ...
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(gm_80160474(*new_var5, i));
      }
    }
  }
  ...
  new_var3 = gmMainLib_8015EDBC()->x14 >= 0x2710;
  if (new_var3)
  {
    fn_80172C78(0x10C);
  }
  ...
  new_var6 = ((((0x100 & 0xFF) & 0xFF) & 0xFF) & 0xFF) & 0xFF;
  if (un_80304690() != 0)
  {
    fn_80172C78(0xAF);
  }
  if (un_80304780() != 0)
  {
    fn_80172C78(((((new_var6 & 0xFF) & 0xFF) & 0xFF) & 0xFF) & 0xFF);
  }
