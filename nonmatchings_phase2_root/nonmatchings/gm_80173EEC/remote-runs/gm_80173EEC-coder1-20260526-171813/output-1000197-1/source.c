...
inline bool inline_fn2(int arg0, int arg1)
{
...
void gm_80173EEC(void)
{
  ...
  u8 ckind;
  u16 *temp_r29;
  for (i = 0; i < (0x19 & 0xFFFFFFFFFFFFFFFF); i++)
  {
    temp_r29 = &gmMainLib_8015EDBC()->x18[i];
    if ((*temp_r29) >= 100)
    {
      ckind = gm_8016400C(i);
      fn_80172C78(inline_fn2(ckind, MJ_CLASSIC));
      if (ckind == CKIND_ZELDA)
      {
        fn_80172C78(inline_fn2(CKIND_SEAK, MJ_CLASSIC));
      }
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(inline_fn2(CKIND_ZELDA, MJ_CLASSIC));
      }
    }
    if ((*temp_r29) >= 200)
    {
      ckind = gm_8016400C(i);
      fn_80172C78(inline_fn2(ckind, MJ_ADVENTURE));
      if (ckind == CKIND_ZELDA)
      {
        fn_80172C78(inline_fn2(CKIND_SEAK, MJ_ADVENTURE));
      }
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(inline_fn2(CKIND_ZELDA, MJ_ADVENTURE));
      }
    }
    if ((*temp_r29) >= 300)
    {
      ckind = gm_8016400C(i);
      fn_80172C78(inline_fn2(ckind, MJ_ALLSTAR));
      if (ckind == CKIND_ZELDA)
      {
        fn_80172C78(inline_fn2(CKIND_SEAK, MJ_ALLSTAR));
      }
      if (ckind == CKIND_SEAK)
      {
        fn_80172C78(inline_fn2(CKIND_ZELDA, MJ_ALLSTAR));
      }
    }
  }
