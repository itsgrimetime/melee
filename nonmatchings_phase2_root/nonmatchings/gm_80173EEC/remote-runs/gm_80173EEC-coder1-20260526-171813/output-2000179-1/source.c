...
void gm_80173EEC(void)
{
  ...
  for (i = 0; i < 0x19; i++)
  {
    ...
    {
      ckind = i;
      fn_80172C78(gm_80160474((((((((((ckind & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF) & 0xFFFFFFFFFFFFFFFF, MJ_ADVENTURE));
      if (ckind == CKIND_ZELDA)
      {
      ...
      if (ckind == CKIND_SEAK)
      {
        new_var = gm_80160474(CKIND_ZELDA, MJ_ADVENTURE);
        fn_80172C78(new_var);
      }
    }
    if ((*temp_r29) >= 300)
