---
name: workflow
description: General workflow management for the Melee decompilation fork. Use when asked about "workflow status", organizing branches, or managing work across the fork structure.
---
