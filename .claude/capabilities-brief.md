...
- debug: artifacts, coalesce-search, diff-schedule, dump, inspect, intervene, measure, mutate, permute, retro, search, select-order-search, solve, suggest, target, util
...
- register allocation: `melee-agent debug inspect causal-diff`, `melee-agent debug inspect lifetime-pressure`, `/mwcc-debug`, `/mwcc-inspect`
