...
echo "  4. Open:   gh pr create --draft -R doldecomp/melee --base master --head itsgrimetime:$PR_BRANCH --label ai-assisted"
echo "           (or https://github.com/doldecomp/melee/compare/master...$PR_BRANCH and add the ai-assisted label)"
echo ""
