...
def collect(fn: Function, source: str) -> IrFacts:
    ...
    # Collect all operand mentions. by_virtual remains the legacy GPR map;
    # by_reg is class-aware and prevents fNN/rNN pollution for solver descriptors.
    by_virtual: dict[int, VirtualFacts] = {}
