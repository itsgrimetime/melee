...
def _frame_taxonomy_next_steps(
    ...
    *,
    ...
    if isinstance(command, str) and command:
        ...
        if taxonomy.get("probe_status") == "ceiling" and cause:
            steps.append(
    ...
    if taxonomy.get("probe_status") not in {
        "needs-attribution",
    ...
    hint.update(
        {
            ...
            "probe_status": taxonomy.get("probe_status"),
    ...
    *,
    ...
    if taxonomy is not None:
        message = (
            ...
            f"with {taxonomy['evidence']} evidence and "
            f"{taxonomy['probe_status']} probe status."
        )
    hint = {
        "kind": "frame-local-area",
        "message": message,
