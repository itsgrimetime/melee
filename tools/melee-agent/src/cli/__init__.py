...
@app.command("dolphin", context_settings={"allow_extra_args": True, "ignore_unknown_options": True}, add_help_option=False)
def dolphin_command(ctx: typer.Context):
    """Owned Dolphin sessions, runtime debugging, controller input, and native PNG capture."""
    from ..dolphin_debug.cli import main
