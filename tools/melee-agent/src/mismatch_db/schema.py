...
CATEGORIES = [
    ...
    "frame",  # Stack frame reservation and frame-size/layout issues
    "branch",  # Branch polarity, conditions
    "comparison",  # Compare/condition operand or signedness shape
    ...
    "cast",  # Cast syntax and cast-driven codegen
    ...
    "data",  # Data symbol or relocation placement
    "section",  # Section-local symbol placement/addressing
    "global",  # Global data load/rematerialization behavior
    "memory",  # Memory access, aliasing, load/store ordering
    "value",  # Value-numbering/rematerialization behavior
    "cse",  # Common-subexpression elimination behavior
    "optimization",  # Optimizer/code motion effects
    "array",  # Array indexing/layout patterns
    "source-transform",  # Source rewrite/probe pattern
    "anti-pattern",  # Known misleading source shapes
    "simplification",  # Simplifying source shapes that improve matching
    "ceiling",  # Known compiler/tooling ceiling
]
