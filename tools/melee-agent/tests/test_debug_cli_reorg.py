...
def test_target_score_dump_expression_score_flags_virtual_renumber_false_hit(
    ...
    assert digit_temp["candidate_virtual"] == 32
    assert digit_temp["actual"] == 1
    ...
    assert anchored_expression["virtuals"]["33"]["candidate_virtual"] == 32
...
def test_target_score_source_remote_fallback_runs_checkdiff_guard(
    ...
    assert payload["structural_guard"] == {"ok": True}
