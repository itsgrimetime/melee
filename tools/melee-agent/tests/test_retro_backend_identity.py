...
def test_capture_identity_can_finalize_from_one_detached_byte_read() -> None:
    ...
    assert identity["candidate_object_sha256"] == hashlib.sha256(candidate_bytes).hexdigest()
