...
from src.layout.objects import _is_anonymous
...
def test_lbl_symbols_are_compared_not_dropped():
    assert _is_anonymous("lbl_80400000") is False
...
def test_mnevent_acceptance_flags_known_issues():
    ...
    assert by_name.get("mnEvent_804D5040") == "reorder"
    assert by_name.get("mnEvent_804D5044") == "reorder"
    assert by_name.get("mnEvent_804D6C60") == "split"
