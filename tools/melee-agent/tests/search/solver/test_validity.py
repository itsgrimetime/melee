...
def test_reject_b_intra_inline():
    # caller_visible_source=False is now derived (Amendment A2) from a
    # synthetic-intermediate provenance KIND (implicit-temp / copy-coalesce /
    # nameless first-def / no source) — the FILTER contract over the
    # ProbeContext bool is unchanged; probe.py computes the bool correctly.
