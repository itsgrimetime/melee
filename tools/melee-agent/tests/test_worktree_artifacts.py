...
_MACOS_ASSET_PUBLICATION_TESTS = {
    "test_seed_and_hydrate_uses_file_level_symlinks",
    "test_hydrate_preserves_real_file_and_rejects_bad_digest",
    "test_seed_makes_cache_payload_files_and_directories_read_only",
    "test_hydrate_rejects_writable_manifest_before_target_mutation",
    "test_hydrate_rejects_writable_cache_directories_before_target_mutation",
    "test_seed_preserves_a_valid_different_cache",
    "test_hydrate_rejects_manifest_platform_and_path_tampering_before_mutation",
    "test_hydrate_seeds_missing_cache_only_with_explicit_source",
    "test_hydrate_preserves_a_mismatched_consumer_symlink",
    "test_inspect_hydrated_assets_binds_links_and_cache_targets",
    "test_inspect_hydrated_assets_rejects_invalid_consumer_tree",
    "test_inspect_hydrated_assets_detects_coherent_cache_replacement",
    "test_hydrate_rejects_cache_root_replacement_before_target_mutation",
    "test_hydrate_rejects_cache_replacement_between_validation_and_snapshot",
    "test_hydrate_retains_its_link_when_cache_changes_after_link_creation",
    "test_hydrate_retains_earlier_links_when_cache_changes_after_second_link",
    "test_hydrate_rejects_prior_payload_replacement_at_final_verification",
    "test_seed_rejects_valid_staging_directory_replacement_before_publish",
    "test_seed_rejects_staging_symlink_replacement_before_publish",
    "test_assets_cli_seeds_and_hydrates_with_explicit_paths",
}


@pytest.fixture(autouse=True)
def _skip_unsupported_asset_publication(request: pytest.FixtureRequest) -> None:
    """Keep portable artifact tests active where secure cache publication is unavailable."""
    test_name = getattr(request.node, "originalname", request.node.name)
    if sys.platform != "darwin" and test_name in _MACOS_ASSET_PUBLICATION_TESTS:
        pytest.skip("secure immutable-cache publication requires macOS renameatx_np")
