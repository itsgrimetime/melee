...
def test_cargo_target_dir_falls_back_when_vendor_checkout_is_missing(tmp_path):
    missing_repo = tmp_path / "missing-retrowin32"

    assert rs._cargo_target_dir(missing_repo) == missing_repo / "target"
