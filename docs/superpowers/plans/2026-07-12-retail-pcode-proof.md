...
Require raw recovery to derive `formatoperands` at `0x004C4BF0`, its bound `0..467`, table base `0x0056287C`, all 468 targets, and its exit closure. Reproduce or explicitly explain each retained lower-bound pair as a separately named audit assertion: 3,187 recovered internal Ghidra functions and 27,020 direct calls in their bodies; 1,861 raw/Ghidra-union arena calls versus 1,825 within recovered bodies; 962 raw selected-PCode-helper calls versus 773 within recovered bodies; and 102 raw unlink-helper calls versus 59 within recovered bodies. These are regression cross-checks, never analyzer completeness truth.
