...
python -m src.cli debug var-to-virtual --help 2>&1 | tail -5
python -m src.cli debug virtual-to-var --help 2>&1 | tail -5
```
...
commands (debug var-to-virtual, debug virtual-to-var), and the
