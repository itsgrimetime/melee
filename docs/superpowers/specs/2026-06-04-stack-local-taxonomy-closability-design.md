...
- `cause`: `pure-reservation`, `lifetime-or-ordering-shift`, `frame-too-large`, `stack-object-offset-shift`, `reserved-unused-low-spill-region`, or `unresolved-attribution`;
...
- `type-size-or-alignment`, `extra-source-local-home`, `missing-source-local-home`, `extra-current-stack-object`, and `missing-current-stack-object` -> `lifetime-or-ordering-shift`;
